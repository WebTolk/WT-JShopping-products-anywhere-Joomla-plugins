	...
	public function register(Container $container)
	{
		$container->set(InstallerScriptInterface::class, new class ($container->get(AdministratorApplication::class)) implements InstallerScriptInterface {
			...
			public function install(InstallerAdapter $adapter): bool
			{
				...
				$object = new \stdClass();
				$object->element = 'wtjshoppingproductsanywhere'; 
				$object->type = 'plugin';
				$object->folder = 'content';
				$object->enabled = 1;
				
				$result = $this->db->updateObject('#__extensions', $object, 'element');
				
				$object2 = new \stdClass();
				$object2->element = 'wtjshoppingproductsanywhereeditorsxtd';
				$object2->type = 'plugin';
				$object2->folder = 'editors-xtd';
				$object2->enabled = 1;
				
				$result = $this->db->updateObject('#__extensions', $object2, 'element');
